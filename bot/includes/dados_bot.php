...
define ('CHAT_ID_NOTIFICACAO', 'ID DO CHAT CANAL PRA RECEBER AS NOTIFY DE RESGATES'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','AQUI VAI SER DO GRUPO PUBLICO E O BOT TEM QUE ESTAR NELE'); // grupo de bot
